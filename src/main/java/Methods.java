...
public class Methods {
    ...
    @Step("Проверка кода ответа при создании дубля юзера")
    ...
    @Step("Проверка кода ответа при получении заказа без юзера")
    ...
    public void assertErrorMessage(ValidatableResponse response, String errorMessage) {
    ...
    public void assertNoIngredientsError(ValidatableResponse response) {
